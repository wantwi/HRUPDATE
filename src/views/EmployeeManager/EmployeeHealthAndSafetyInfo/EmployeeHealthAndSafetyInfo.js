...
import { CInputGroupAppend, CInputGroup, CInput, CCard, CCardBody, CFormGroup, CCol, CRow, CButton, CModal, CModalHeader, CModalTitle, CModalBody, CModalFooter, CLabel, CTextarea, CSelect } from '@coreui/react';
import {
...
const EmployeeHealthAndSafetyInfo = (props) => {
    ...
    return (
        <>
            <CRow>
                <CCol xs="12"><h5><CSLab code="Employee Health And Safety Info" /></h5></CCol>
            </CRow>
            <CRow >
                <CCol md="4">
                    <CFormGroup>
                        <CInputGroup>
                            <CInput className='border-left-curve' type="text" id="username3" name="username3" autoComplete="name" placeholder={TransLabelByCode('Search for Employee by name')} />
                            <CInputGroupAppend>
                        ...
                        <CCardBody style={{height: CardBodyHeight, overflowY: 'auto'}}>
                            <CRow>
                                <CCol md='12' style={{ marginBottom: '5px' }}>
                                    <CButton  type="button" size="sm" color="primary" onClick={() => setVisible(true)}><AiOutlinePlus /><CSLab code='Add Employee Health And Safety Info' /> </CButton>
                                    </CCol>
                                <CCol md='12'>
                                    ...
                                    <ColumnsDirective>
                                            ...
                                            <ColumnDirective field={'accidentType'} headerText="Accident Type" width='100' />
                                            <ColumnDirective field={'cost'} headerText="Cost" width='100' />
            ...
            <CModal show={visible} size={'lg'} onClose={() => setVisible(false)} closeOnBackdrop={false}>
                <CModalHeader>
                    <CModalTitle> <CSLab code='Add Employee Health And Safety Info' /> </CModalTitle>
                </CModalHeader>
                <CModalBody>
                    <CRow>
                        <CCol md="3">
                            <CLabel htmlFor="date"><CSLab code='Date' /></CLabel>
                            <CInput className="" id="date" type="date" />
                        </CCol>                        
                        <CCol md="4">
                            <CLabel htmlFor="accidentType"><CSLab code='Accident Type' /></CLabel>
                           <CSelect>
                               {
                                   ['Select Accident Type', 'Type 1', 'Type 2'].map((x,i)=><option value={x} key={1}>{x}</option>)
                               }
                           </CSelect>
                        </CCol>                        
                        <CCol md="2">
                            <CLabel htmlFor="cost"><CSLab code='Cost' /></CLabel>
                            <CInput className="" style={{textAlign: 'right'}} placeholder="0.00" id="cost" type="text" />
                        </CCol>
                        <CCol md="3">
                    ...
                    <CRow >
                        <CCol md="12">
                            <CLabel htmlFor="description"><CSLab code='Description' /></CLabel>
                            <CTextarea id='description' style={{ height: '80px',resize:"none" }}></CTextarea>
                        </CCol>
                    </CRow>
                </CModalBody>
                <CModalFooter>
