  ...
  return (
    <>
      <CRow>
        <CCol xs="12">
          <h5>
            <CSLab code="HCM-BGTAZ61EZUQ-KCMI" />
          </h5>
        </CCol>
      </CRow>
      <CRow>
            ...
            <CInputGroup>
              <CInput
                ...
                placeholder={TransLabelByCode(
                  "Search for Employee Career Plan by name"
                )}
              />
              <CInputGroupAppend>
                <CButton
                ...
                <CTabs>
                  <CNav variant="tabs">
                    <CNavItem>
                      ...
                      >
                        <CSLab code="HCM-1Q02EGS6URJ_PSLL" />
                      </CNavLink>
                    </CNavItem>
                    <CNavItem>
                      <CNavLink
                      ...
                      >
                        <CSLab code="HCM-1S477XKGTCT-LOLN" />
                      </CNavLink>
                    </CNavItem>
                    <CNavItem>
                      <CNavLink
                      ...
                      >
                        <CSLab code="HCM-PTQZZ6WXJF_PSLL" />
                      </CNavLink>
                    </CNavItem>
                    <CNavItem>
                      <CNavLink
                      ...
                      >
                        <CSLab code="HCM-X0CF5RQX4K_LANG" />
                      </CNavLink>
                    </CNavItem>
                  </CNav>
