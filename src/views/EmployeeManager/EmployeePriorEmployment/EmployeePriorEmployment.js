  ...
  return (
    <>
      <CRow>
        <CCol xs="12">
          <h5>
            <CSLab code="HCM-7HXSKOS8KA_LOLN" />
          </h5>
        </CCol>
      </CRow>
      <CRow>
        ...
        <CCol xs="12" hidden={show}>
          <CCard>
            <CCardBody style={{ height: CardBodyHeight, overflowY: "auto" }}>
              ...
              >
                {" "}
                <AiOutlinePlus /> <CSLab code="HCM-7HXSKOS8KA_LOLN" />
              </CButton>
      ...
      >
        ...
        <CModalBody>
          <CRow className={"bottom-spacing"}>
            <>
              <CCol md="8">
                <CLabel htmlFor="Organisation">
                  <CSLab code="HCM-YLK06AGBK7F-KCMI" />
                </CLabel>
