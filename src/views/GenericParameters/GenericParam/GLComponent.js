            ...
            <CRow>
                <CCol md='5'>
                    ...
                    <CRow>
                        ...
                        <CCol md="6">
                            <CLabel><CSLab code="Tax Relief" /></CLabel><br />
                ...
                <CCol md='6'>
                    <CRow>
                        <CCol md="6">{/*  Saving Schemes */}
                            <CSLineLabel name="Mandatory" />
                        </CCol>
                        <CCol md="6">
                            <CSLineLabel name="Voluntary" />
                        </CCol>
                    </CRow>
                    ...
                    <CRow>
                        <CCol md="6">
                            <CRow>
                                <CCol md="12">
                                    <CLabel><CSLab code="Employee Contribution GL" /></CLabel><br />
                                ...
                                <CCol md="12">
                                    <CLabel><CSLab code="Employer Contribution GL" /></CLabel><br />
                                ...
                                <CCol md="12">
                                    <CLabel><CSLab code="Employer Total Payable" /></CLabel><br />
                        ...
                        <CCol md='6'>
                            <CRow>
                                ...
                                <CCol md="12">
                                    <CLabel htmlFor="rate"><CSLab code="Employer Total Payable" /></CLabel><br />
