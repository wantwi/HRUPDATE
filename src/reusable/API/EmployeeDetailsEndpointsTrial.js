 ...
 * @returns urlpath
 */
export const SearchEmployeeByNameOrCode = (
  query,
  pageNumber,
  numberOfItems,
  orderBy,
 ...
 */
export const GetAllEmployee = (query) =>
  `${EmployeeDetailsBaseAPIURL}Employees/filter?Filter=${query}`;
 ...
 * @returns urlpath
 */
export const GetsalaryGradeNotch = (salaryGradeId) =>
  `${EmployeeDetailsBaseAPIURL}SalaryGrades/${salaryGradeId}/notches`;
 ...
 * @returns urlpath
 */
export const GetOrgsByType = (type) =>
  `${EmployeeDetailsBaseAPIURL}Orgs/${type}`;
 ...
 * @returns urlpath
 */
export const GetBankBranchesByBandId = (bankId) =>
  `${EmployeeDetailsBaseAPIURL}Banks/${bankId}/branches`;

/**
 * Endpoint to get Supervisor Group
 */
export const GetSupervisorGroup = () =>
  `${EmployeeDetailsBaseAPIURL}Users/SupervisorGroups`;
