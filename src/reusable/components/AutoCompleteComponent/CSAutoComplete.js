...
const CSAutoComplete = ({ filterUrl, uniqueIdKey, displayTextKey, placeholder, handleSelect, input, setInput, searchName, emptySearchFieldMessage, isPaginated, pageNumber, setPageNumber, numberOfItems, setNumberOfItems, orderBy, setOrderBy, sortOrder, setSortOrder, selectNumberOfItems, mode, setMode, reset }) => {
                            ...
                            <CCol style={{ position: 'absolute', bottom: '0px', marginTop: 5, backgroundColor: 'white', }}>
                                <CRow>
                                    <CCol md={7} xs={9} >
                                        <div className="pagination">
                                            ...
                                            <div className="page-item" style={{ marginRight: '5px', padding: '5px' }}><CButton size={'lg'} className="page-link"
                                                onClick={() => {
                                                    console.log({ _pageNumber, _currentPage, currentPage, pageNumber, totalPages });
                                            ...
                                            {/* Page Count */}
                                            <div style={{ marginTop: '15px' }} className="page-item">{currentPage === 0 ? currentPage + 1 : currentPage} of {totalPages}</div>
                                    ...
                                    <CCol md={5} xs={6} className="text-right">
                                        <li style={{ marginLeft: '5px', marginTop: '15px' }}>Records: {totalResults === 0 && suggestions.length > 0 ? suggestions.length : totalResults}</li>
                                    </CCol>
                                </CRow>
                            </CCol>
                            :
