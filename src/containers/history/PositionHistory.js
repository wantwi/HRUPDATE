...
import ViewPositionDetails from "./ViewPositionDetails";
    ...
    <>
      ...
      >
        <CModalHeader closeButton>
          <CModalTitle>
            <CSLab name="History" code={"HCM-OP6HH1ER0WN_LANG"} />{" "}
            {isGL ? " (GL)" : ""} : {searchResult?.code || ""} -{" "}
            {searchResult?.name || ""}
          </CModalTitle>
        </CModalHeader>
        <CModalBody>
          <CRow>
            ...
            <CCol md="6">
              <div
                className="daterangepicker-control-section mb-1 _dateRange"
                style={{
